...
public class ConfigurationAdv {

    public static final String MSG_TAG = "TETHER -> AdvancedConfiguration";
    ...
    public ConfigurationAdv(String device) {
        this.device = device;
        this.sdk = android.os.Build.VERSION.SDK_INT; //Integer.parseInt(NativeTask.getProp("ro.build.version.sdk"));
